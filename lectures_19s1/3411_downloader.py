"""
    ...
    http://www.cse.unsw.edu.au/~cs3411/1s1/lect/ to the current directory
...
if __name__ == "__main__":
    url = "http://www.cse.unsw.edu.au/~cs3411/19t1/lect/"
    r = requests.get(url)
    ...
    while 1:
        ...
        if matchObj:
            ...
            download_url = "http://www.cse.unsw.edu.au/~cs3411/19t1/lect/"+matchObj.group(2)+".pdf"
